...
const RequestCard = (props: { name: string, number: string, work: string, course: string, date: string, deadline?: boolean }) => {

    const randomColor = getRandomColor();

    return <>
        <div className={classes.container} style={{ backgroundColor: props.deadline ? '#FFCFBA' : '#E9EAFF' }}>
